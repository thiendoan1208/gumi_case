...
function OrderRecievedEmail({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://gumi-case.vercel.app";

  return (
    <Html>
      <Head>
        <Preview>Your order summary and esitmated delivery date</Preview>
        <Body style={main}>
          <Container style={container}>
            <Section style={message}>
              <Img
                src={`${baseUrl}/gumi-case-logo.png`}
                width="65"
                height="73"
                alt="delivery logo"
                style={{ margin: "auto" }}
            ...
            <Section style={paddingY}>
              ...
              <Row>
                <Text style={footer.text}>
                  © GumiCase, Inc. All Rights Reserved.
                </Text>
              </Row>
            </Section>
          </Container>
